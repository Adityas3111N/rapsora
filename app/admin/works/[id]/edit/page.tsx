...
export default function EditWorkPage({ params }: { params: { id: string } }) {
    ...
    useEffect(() => {
        const fetchWork = async () => {
            try {
                // To avoid Next.js 15 sync params error wait manually or just use string
                // In client components wrapped by next/navigation it's fine
                ...
                if (data.work) {
                    ...
                    setForm({
                        ...
                        gridSize: w.gridSize || 'medium',
                        testimonialQuote: w.testimonial?.quote || '',
                        testimonialAuthor: w.testimonial?.author || '',
                        testimonialRole: w.testimonial?.role || '',
                        testimonialCompany: w.testimonial?.company || '',
                    });
                }
            } catch (error) {
    ...
    if (loading) {
        return <div className="text-center py-20 text-white/40">Loading project...</div>;
    }
        ...
        <div className="max-w-4xl mx-auto space-y-6 pb-20">
            ...
            >
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-heading font-bold text-white tracking-tight">Edit Project</h1>
                    </div>
                </div>
