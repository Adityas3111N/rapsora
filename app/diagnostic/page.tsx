...
export default function DiagnosticPage() {
    ...
    return (
        <main className="relative min-h-screen w-full bg-[#0A0A0B] text-white overflow-hidden flex flex-col">
            {/* Ambient Background */}
            ...
            {/* Focused Header */}
            <header className="relative z-20 w-full p-8 flex items-center justify-between">
                <Logo />
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-white/5 rounded-full border border-white/10">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-widest text-white/40">Growth Diagnostic Active</span>
                    </div>
                </div>
            </header>
                    ...
                    >
                        ...
                        {currentStep.type !== 'result' && currentStep.type !== 'processing' && (
                            <div className="mb-12">
                                ...
                                <p className="mt-4 text-[12px] font-bold text-white/30 uppercase tracking-[0.2em] text-center">
