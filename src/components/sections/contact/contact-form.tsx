                                ...
                                <div className="pt-2">
                                    <Magnetic>
                                        <button 
                                            type="submit" 
                                            disabled={submitting}
                                            className="group relative inline-flex items-center justify-center h-[60px] px-8 rounded-full bg-foreground text-background font-bold text-[16px] hover:bg-primary hover:text-primary-foreground transition-all duration-300 disabled:opacity-70 disabled:pointer-events-none"
                                        >
                                            {submitting ? (
                                                ...
                                                <>
                                                    ...
                                                    <div className="absolute right-2 top-1/2 -translate-y-1/2 w-11 h-11 rounded-full bg-background/10 flex items-center justify-center ml-4 group-hover:bg-primary-foreground group-hover:text-primary transition-all duration-300">
